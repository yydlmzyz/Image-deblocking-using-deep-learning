...
def MS(ms_model,inputs):
    inputs_1=downsampling(inputs)
    inputs_2=downsampling(inputs_1)
    outputs, outputs_1, outputs_2 = ms_model(inputs,inputs_1,inputs_2)
    return outputs
...
def test():
	...
	#print(input_image.size())
        ...
        output_image=Variable(torch.zeros(batch_number,channel,height,width).cuda(),volatile=True)
